...
{
    const ResourceName :String = "he.text_vector.font_face.runtime_blob";
...
{
    const ResourceName :String = "he.text_vector.font_family.runtime_blob";
...
{
    const ResourceName :String = "he.text_vector.vector_image.runtime_blob";

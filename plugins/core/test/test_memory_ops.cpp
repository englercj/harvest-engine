...
// ------------------------------------------------------------------------------------------------
HE_TEST(core, memory_ops, Rotl)
{
    HE_EXPECT_EQ(Rotl(0x00000001u,  1), 0x00000002u);
    HE_EXPECT_EQ(Rotl(0x00000001u,  4), 0x00000010u);
    HE_EXPECT_EQ(Rotl(0x00000001u,  8), 0x00000100u);
    HE_EXPECT_EQ(Rotl(0x00000001u, 16), 0x00010000u);

    HE_EXPECT_EQ(Rotl(0x0000000000000001ull,  1), 0x0000000000000002ull);
    HE_EXPECT_EQ(Rotl(0x0000000000000001ull,  4), 0x0000000000000010ull);
    HE_EXPECT_EQ(Rotl(0x0000000000000001ull,  8), 0x0000000000000100ull);
    HE_EXPECT_EQ(Rotl(0x0000000000000001ull, 16), 0x0000000000010000ull);
}

// ------------------------------------------------------------------------------------------------
HE_TEST(core, memory_ops, Rotr)
{
    HE_EXPECT_EQ(Rotr(0x00000001u,  1), 0x80000000u);
    HE_EXPECT_EQ(Rotr(0x00000001u,  4), 0x10000000u);
    HE_EXPECT_EQ(Rotr(0x00000001u,  8), 0x01000000u);
    HE_EXPECT_EQ(Rotr(0x00000001u, 16), 0x00010000u);

    HE_EXPECT_EQ(Rotr(0x0000000000000001ull,  1), 0x8000000000000000ull);
    HE_EXPECT_EQ(Rotr(0x0000000000000001ull,  4), 0x1000000000000000ull);
    HE_EXPECT_EQ(Rotr(0x0000000000000001ull,  8), 0x0100000000000000ull);
    HE_EXPECT_EQ(Rotr(0x0000000000000001ull, 16), 0x0001000000000000ull);
}

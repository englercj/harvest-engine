...
namespace he::editor
{
    ...
    void ImGuiService::SetupStyle(ImGuiStyle& style)
    {
        ...
        style.ItemSpacing                       = ImVec2(4, 2);         // Horizontal and vertical spacing between widgets/lines
        ...
        style.ScrollbarSize                     = 18.0f;                // Width of the vertical scrollbar, Height of the horizontal scrollbar

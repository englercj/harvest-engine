...
- Replaced the docs-only `plugins/text_vector` manifest with real module scaffolding.
...
- Verified targeted Windows builds for:
  ...
  - `he_text_vector`
  - `he_text_layout`
  - `he_text_vector_assets__schemac_1`
  - `he_text_vector_assets`
...
- `assets/include/he/text_vector/schema/runtime_blob.hsc`

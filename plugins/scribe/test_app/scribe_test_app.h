...
namespace he
{
    ...
    private:
        ...
        scribe::LayoutResult m_gpuGraphLabelLayouts[5]{};
        scribe::RetainedTextModel m_retainedGpuGraphLabels[5]{};
        ...
        Vec2f m_gpuGraphOrigin{ 0.0f, 0.0f };
        Vec2f m_gpuGraphSize{ 0.0f, 0.0f };
        Vec2f m_gpuGraphLabelOrigins[5]{};
        ...
        float m_smoothedGpuFrameMs{ 0.0f };
        ...
        Vector<float> m_gpuFrameHistory{};
        uint32_t m_gpuFrameHistoryHead{ 0 };
        bool m_gpuFrameHistoryFilled{ false };

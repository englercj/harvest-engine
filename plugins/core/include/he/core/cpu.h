...
/// Defined as one (1) when the target is 32-bit ARM platforms, and zero (0) otherwise.
#define HE_CPU_ARM_32               0

/// Defined as one (1) when the target is 64-bit ARM platforms, and zero (0) otherwise.
#define HE_CPU_ARM_64               0

/// Defined as one (1) when the target is any WASM platform, and zero (0) otherwise.
#define HE_CPU_WASM                 0

/// Defined as one (1) when the target is 32-bit WASM platforms, and zero (0) otherwise.
#define HE_CPU_WASM_32              0

/// Defined as one (1) when the target is 64-bit WASM platforms, and zero (0) otherwise.
#define HE_CPU_WASM_64              0

/// Defined as one (1) when the target is any x86 platform, and zero (0) otherwise.
#define HE_CPU_X86                  0

/// Defined as one (1) when the target is 32-bit x86 platforms, and zero (0) otherwise.
#define HE_CPU_X86_32               0

/// Defined as one (1) when the target is 64-bit x86 platforms, and zero (0) otherwise.
#define HE_CPU_X86_64               0

/// Defined as one (1) when the target is any 32-bit platform, and zero (0) otherwise.
#define HE_CPU_32_BIT               0

/// Defined as one (1) when the target is any 64-bit platform, and zero (0) otherwise.
#define HE_CPU_64_BIT               0

/// Defined as one (1) when the target is big endian.
#define HE_CPU_BIG_ENDIAN           0

/// Defined as one (1) when the target is little endian.
...
/// implementation-specific amount of time. This is useful in spin-wait loops.
    ...
    #else
        #define HE_CPU_SPIN_WAIT_PAUSE()    asm volatile("yield;" ::: "memory")
    #endif
#elif HE_CPU_WASM
    #define HE_CPU_SPIN_WAIT_PAUSE()        _mm_pause()
        ...
        #define HE_CPU_SPIN_WAIT_PAUSE()    _mm_pause()
    #else
        #define HE_CPU_SPIN_WAIT_PAUSE()    asm volatile("pause;" ::: "memory")
    #endif
#endif

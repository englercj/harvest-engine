...
// ------------------------------------------------------------------------------------------------
HE_TEST(math, types, Vec2T)
{
    static_assert(IsSpecialization<Vec2f, Vec2T>);
    static_assert(std::is_same_v<Vec2f::Type, float>);
    static_assert(Vec2f::Size == 2);

    static_assert(IsSpecialization<Vec2i, Vec2T>);
    static_assert(std::is_same_v<Vec2i::Type, int32_t>);
    static_assert(Vec2i::Size == 2);

    static_assert(IsSpecialization<Vec2u, Vec2T>);
...
// ------------------------------------------------------------------------------------------------
HE_TEST(math, types, Vec3T)
{
    static_assert(IsSpecialization<Vec3f, Vec3T>);
    static_assert(std::is_same_v<Vec3f::Type, float>);
    static_assert(Vec3f::Size == 3);

    static_assert(IsSpecialization<Vec3i, Vec3T>);
    static_assert(std::is_same_v<Vec3i::Type, int32_t>);
    static_assert(Vec3i::Size == 3);

    static_assert(IsSpecialization<Vec3u, Vec3T>);
...
// ------------------------------------------------------------------------------------------------
HE_TEST(math, types, Vec4T)
{
    static_assert(IsSpecialization<Vec4f, Vec4T>);
    static_assert(std::is_same_v<Vec4f::Type, float>);
    static_assert(Vec4f::Size == 4);

    static_assert(IsSpecialization<Vec4i, Vec4T>);
    static_assert(std::is_same_v<Vec4i::Type, int32_t>);
    static_assert(Vec4i::Size == 4);

    static_assert(IsSpecialization<Vec4u, Vec4T>);
    ...
    constexpr Vec4T<float> a{ 1, 2, 3, 4 };

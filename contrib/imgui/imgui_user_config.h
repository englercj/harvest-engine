...
#define IM_VEC2_CLASS_EXTRA                                                         \
        constexpr ImVec2(const he::Vec2f& f) : x(f.x), y(f.y) {}                    \
...
#define IM_DEBUG_BREAK() HE_DEBUG_BREAK()
...
//---- Define ImTextureID for type checking
namespace he::rhi { struct DescriptorTable; }
#define ImTextureID he::rhi::DescriptorTable*

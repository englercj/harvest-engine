...
public abstract class KdlValue(string? type) : IKdlObject
{
    ...
    public static bool operator==(KdlValue? a, object? b) => (a is null) ? b is null : a.Equals(b);
    public static bool operator!=(KdlValue? a, object? b) => !(a == b);
    public static bool operator==(object? a, KdlValue? b) => (b is null) ? a is null : b.Equals(a);
    public static bool operator!=(object? a, KdlValue? b) => !(a == b);
}

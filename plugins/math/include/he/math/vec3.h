...
namespace he
{
    ...
    template <typename T1, typename T2> constexpr Vec3<T1> MakeVec3(const Vec2<T2>& v, typename Vec2<T2>::Type z = 0);
    ...
    template <typename T> Vec3<T> Sqrt(const Vec3<T>& v);

    // Returns the component-wise reciprocal square root of `v`.
    template <typename T> Vec3<T> Rsqrt(const Vec3<T>& v);
    ...
    template <typename T> T Len(const Vec3<T>& v);
    ...
    template <typename T> Vec3<T> NormalizeSafe(const Vec3<T>& v);

    // Returns true if `v` is a normalized vector.
    template <typename T> bool IsNormalized(const Vec3<T>& v);

    // --------------------------------------------------------------------------------------------
    // Operators

    template <typename T> constexpr Vec3<T> operator-(const Vec3<T>& v);

    template <typename T> constexpr Vec3<T> operator+(const Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T> operator-(const Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T> operator*(const Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T> operator/(const Vec3<T>& a, const Vec3<T>& b);

    template <typename T> constexpr Vec3<T> operator+(const Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T> operator-(const Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T> operator*(const Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T> operator/(const Vec3<T>& a, T b);

    template <typename T> constexpr Vec3<T>& operator+=(Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T>& operator-=(Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T>& operator*=(Vec3<T>& a, const Vec3<T>& b);
    template <typename T> constexpr Vec3<T>& operator/=(Vec3<T>& a, const Vec3<T>& b);

    template <typename T> constexpr Vec3<T>& operator+=(Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T>& operator-=(Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T>& operator*=(Vec3<T>& a, T b);
    template <typename T> constexpr Vec3<T>& operator/=(Vec3<T>& a, T b);
